...
namespace Ordering.Infrastructure.Data.Extensions
{
  ...
  new List<Customer>
  {
        Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "utpal", "utpal@yopmail.com"),
        Customer.Create(CustomerId.Of(new Guid("189dc8dc-990f-48e0-a37b-e6f2b60b9d7d")), "priyanka", "priyanka@yopmail.com")
  };
        ...
        public static IEnumerable<Order> OrdersWithItems
        {
            get
            {
                var address1 = Address.Of("utpal", "maity", "utpal@yopmail.com", "Argari", "Howrah", "India", "71130");
                var address2 = Address.Of("pariyanka", "paul", "priyanka@yopmail.com", "Manikpir", "Kolkata", "India", "71130");

                var payment1 = Payment.Of("utpal", "5555555555554444", "12/28", "355", 1);
                var payment2 = Payment.Of("priyanka", "8885555555554444", "06/30", "222", 2);
